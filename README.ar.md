...
# 🦁 XXD Panel 073｜دفتر المدينة الهندسية

### يعيد بناء الصور كعمارة مصغرة مقطعية ذات سقالات عقلانية
...
تبقى `sample-01`–`sample-04` محجوزة لنماذج الإصدار الأصلية القابلة للتحقق. تضم الأعمال الثمانية أعلاه أربعة نماذج أفقية 16:9 بتكوين يسار–يمين وأربعة نماذج رأسية 3:4 بتكوين أعلى–أسفل. ولّد Panel 073 كل عمل بصورة مستقلة وفق موجّهه الأصلي، من دون إعادة استخدام أعمال أي Panel آخر. تستخدم النماذج نصاً إنجليزياً مولّداً بذكاء.
...
يختزل **Panel 073** العنصر إلى مشهد معماري مصغر متساوي القياس ومفتوح المقطع، بعمق يشبه طبقات الجرف القاري تحت الماء. ليست السقالات الدقيقة زينة؛ بل بنية عقلانية تلف العنصر وتدعمه وتبنيه وتصلحه وتمسحه حول المحيطات والمنعطفات وأوجه القطع. يجمع الورق الأبيض المحبب وإشارات اللون المشرقة من المصدر والملاحظات التحريرية المقتصدة بين دقة الرسم المعماري وخفة الملصق الفني.

### مناسب لـ

- فضاء متساوي القياس ومقطوع صحيح، بعلاقات واضحة بين المنظور والطبقات والمقاطع، لا عمق زائف بمنظور خاطئ؛
- سقالات ذات منطق حقيقي، تخدم عناصرها الأفقية والعمودية وعُقدها عملية الإحاطة أو الدعم أو الترميم أو المسح؛
- ملصق بحث معماري يجمع نموذجاً مصغراً ورسماً تفسيرياً رفيعاً وورقاً أبيض منسوجاً وتعليقات مقتصدة بنظام يشبه كتالوج المعرض؛
- مخرجات أعلى–أسفل ويسار–يمين وتصميم فقط ونسب متعددة وحزم خلفيات ومعالجة المجلدات.

### بداية سريعة

> استخدم XXD Panel 073 لمعالجة هذه الصورة واقترح أولاً أنسب تكوين وحجم.
...
**البصمة:** عمارة مصغرة متساوية القياس · مكعب مقطوع · مقطع جرف قاري · سقالات عقلانية · رسم معماري يدوي · ورق أبيض محبب
...
|---|---|
| **الناتج** | ملصق عمارة مصغرة مقطعي ومتساوي القياس، تكون فيه السقالات والعنصر نظامًا مكانيًا دقيقًا واحدًا |
| **البصمة الواضحة** | نموذج مجسم مصغر فوق ورق أبيض محبب، وطبقات مقطعية واضحة، وسقالات تتبع العقد البنيوية |
| **احترام المصدر** | يحافظ على المحيط والبنية والوضعية والعلاقة السردية، ثم يضيء إشارات لون المصدر وينقيها |
...
```text
تثبيت المحيط والبنية والوضعية والعلاقة السردية → بناء إسقاط متساوي القياس ومقطع صحيح → ضغطه إلى نموذج معماري مصغر بطبقات كالجرف القاري → إنشاء سقالات متصلة حول المحيط والمنعطفات وأوجه القطع → التعبير بخطوط رفيعة ولون مسطح ودرجات مصدر مضاءة → تعليقه فوق ورق أبيض محبب → إضافة ملاحظات معمارية مقتصدة
```

## سمات النتيجة النهائية

- يستخدم إسقاطًا متساوي القياس صحيحًا ومكعبًا مقطوعًا أو مقطعًا كالجرف القاري بطبقات مكانية موثوقة.
- يبني السقالات من عناصر أفقية ورأسية وعقد اتصال تتبع البنية فعلًا بدل أن تطفو كالكولاج.
- يجمع الهندسة البسيطة واللون المسطح والخطوط الرفيعة والتفاصيل البنيوية المعتدلة في رسم معماري يدوي.
- يحافظ على إشارات لون المصدر ثم يضيئها وينقيها ويزيل الرمادية.
- يستخدم الورق الأبيض المحبب والفراغ الواسع والظل الضعيف والملاحظات الإنجليزية القليلة لصنع نظام ملصق بحثي.

توجد القيود الجمالية فقط في [الموجّه الأصلي](references/original-prompt/zh-CN.md). يعالج الـ Skill ومهايئات التشغيل متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-073-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 073. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-073 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-073 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-073 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-073 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-073 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 073 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-073 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-073`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-073-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-073-prompt.zh-CN.md)

<!-- xxd-panel-catalog:start -->
## دليل مشاريع XXD Panel الكامل

يحافظ كل مشروع من مشاريع Panel الـ73 على موجّهه الأصلي ومنطقه الجمالي المستقل. يسرد الجدول المشاريع من 001 إلى 073 دون أرقام مفقودة، مع تمييز المشروع الحالي بخط عريض.
...
| **الجنود** | `xxd-panel-NNN` (حالياً 001–073) | تنفذ كل مهارة مرقمة موجّهها الأصلي وجماليتها الخاصة فقط، وتنجز المهمة الفردية التي يرسلها الجنرال. |
