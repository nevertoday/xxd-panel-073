...
```text
/xxd-panel-073 <source-or-directory> --mode top-bottom,design-only \
...
1. 上下对照（原图在上，073 设计在下）
2. 左右对照（原图在左，073 设计在右）
...
```text
~/Desktop/xxd/xxd-panel-073/<fresh-task>/
...
- `references/xxd-panel-073-prompt.zh-CN.md`
- `references/xxd-panel-073-prompt.en.md`
